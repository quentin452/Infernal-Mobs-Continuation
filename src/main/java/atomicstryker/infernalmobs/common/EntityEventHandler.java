        ...
        if (!event.entityLiving.worldObj.isRemote) {
            ...
            if (antiMobFarm && System.currentTimeMillis() > nextMapEvaluation) {
                if (!damageMap.isEmpty()) {
                    ...
                    // FMLLog.log("InfernalMobs", Level.DEBUG, String.format("Infernal Mobs AntiMobFarm damage check,
                    // max detected chunk damage value %s near coords %e, %e", maxDamage, maxC.getCenterXPos(),
